...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
        Use ContentValues to write data to shelter.db / pets table
     */
    ...
    public void savePet(){
        ...
        if (mCurrentPetUri == null && TextUtils.isEmpty(nameString) && TextUtils.isEmpty(nameString) &&
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage("Unsaved Pet");
